...
const mockContainer : Container = new Container();

// Infrastructure
mockContainer.bind<PeopleRepositoryInterface>(TYPES.PeopleRepository).to(MockApiPeopleRepository);
// mockContainer.bind<VehicleRepositoryInterface>(TYPES.VehicleRepository).to(DynamoVehicleRepository).inSingletonScope();

// Application
mockContainer.bind<PeopleAppService>(TYPES.PeopleAppService).to(PeopleAppService).inSingletonScope();
// mockContainer.bind<VehicleAppService>(TYPES.VehicleAppService).to(VehicleAppService).inSingletonScope();

// Domain
mockContainer.bind<PeopleDomainService>(TYPES.PeopleDomainService).to(PeopleDomainService).inSingletonScope();
// mockContainer.bind<VehicleDomainService>(TYPES.VehicleDomainService).to(VehicleDomainService).inSingletonScope();
